...
import tb.angularjs.service.UserService;
import tb.angularjs.web.dto.UserDTO;
...
public class AccountController {
    ...
    private boolean checkPasswordLength(String password) {
      return false;//(!StringUtils.isEmpty(password) && password.length() >= UserDTO.PASSWORD_MIN_LENGTH && password.length() <= UserDTO.PASSWORD_MAX_LENGTH);
    }
}
