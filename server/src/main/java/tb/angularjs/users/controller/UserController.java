package tb.angularjs.users.controller;
...
import tb.angularjs.users.model.*;
import tb.angularjs.users.repository.CompanyRepository;
import tb.angularjs.users.repository.PersonRepository;
import tb.angularjs.users.repository.UserRepository;
